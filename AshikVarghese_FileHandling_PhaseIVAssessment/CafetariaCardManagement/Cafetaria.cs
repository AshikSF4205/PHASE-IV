...
class Cafetaria
{
    static public CustomList<UserDetails> userList = new CustomList<UserDetails>();
    static public CustomList<FoodDetails> foodList = new CustomList<FoodDetails>();
    static public CustomList<OrderDetails> orderList = new CustomList<OrderDetails>();
    static public CustomList<CartItems> cartlist = new CustomList<CartItems>();
    static public UserDetails currentLoggedInUser;
    public static void MainMenu()
    {
        System.Console.WriteLine("\n------------------------WELCOME TO CAFETARIA CARD MANAGEMENT PORTAL------------------------");
        System.Console.WriteLine("|                                                                                         |");
        ...
        do
        {
            ...
            switch (option)
            {
                ...
                default: 
                    {
                        System.Console.WriteLine("Invalid Option! Enter [1/2/3]");
                        break;
                    }
            }
        ...
        do
        {
            ...
            switch (option)
            {
                ...
                case 'g': 
                    {
                        check = false;
                        System.Console.WriteLine("Redirecting back to main menu.......");
                        break;
                    }
                default: 
                    {
                        System.Console.WriteLine("Invalid Option! Enter [a/b/c/d/e/f/g]");
                        break;
                    }
            }
        } while (check);
